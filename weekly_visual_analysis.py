...
def weekly_visual_analysis():
    ...
    data = dict_ridge_statistics[loc]
    ...
    LI_thickness = ax_ice_data.step(dict_ridge_statistics[loc]['keel_dateNum'], dict_ridge_statistics[loc]['level_ice_deepest_mode'], where='mid', color='green', label='Level ice draft estimate')
    ...
    RidgePeaks_thisWeek = ax_ice_data.scatter(dict_ridge_statistics[loc]['keel_dateNum'], dict_ridge_statistics[loc]['keel_draft'], color='red', label='Individual ridge peaks')
    LI_thickness_thisWeek = ax_ice_data.step(dict_ridge_statistics[loc]['keel_dateNum'], dict_ridge_statistics[loc]['level_ice_deepest_mode'], where='mid', color='green', label='Level ice draft estimate')
    ...
    number_of_ridges_thisYear = ax_number_of_ridges.scatter(dict_ridge_statistics[loc]['level_ice_deepest_mode'], dict_ridge_statistics[loc]['number_of_ridges'], color='red', label='this year/location')
    # initialize rectangle to mark the current data point (week)
    ...
    while True:
        ...
        RidgePeaks_thisWeek = ax_ice_data.scatter(dict_ridge_statistics[loc]['keel_dateNum'][week], dict_ridge_statistics[loc]['keel_draft'][week], color='red', label='Individual ridge peaks')
        ...
        number_of_ridges_thisYear = ax_number_of_ridges.scatter(dict_ridge_statistics[loc]['level_ice_deepest_mode'][week], dict_ridge_statistics[loc]['number_of_ridges'][week], color='red', label='this year/location')
        T4.remove()
        T4 = ax_number_of_ridges.text(0.5, 0.5, f"LI DM = {dict_ridge_statistics[loc]['level_ice_deepest_mode'][week]} || N = {dict_ridge_statistics[loc]['number_of_ridges'][week]}", fontsize=12, transform=ax_number_of_ridges.transAxes)
